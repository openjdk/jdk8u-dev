...
public abstract class AbstractCheckSignatureSchemes extends SSLEngineTemplate {
    ...
    protected static final Map<Integer, String> sigSchemeMap;
    static {
        Map<Integer, String> temp = new HashMap<>();
        temp.put(0x0401, "rsa_pkcs1_sha256");
        temp.put(0x0501, "rsa_pkcs1_sha384");
        temp.put(0x0601, "rsa_pkcs1_sha512");
        temp.put(0x0403, "ecdsa_secp256r1_sha256");
        temp.put(0x0503, "ecdsa_secp384r1_sha384");
        temp.put(0x0603, "ecdsa_secp521r1_sha512");
        temp.put(0x0804, "rsa_pss_rsae_sha256");
        temp.put(0x0805, "rsa_pss_rsae_sha384");
        temp.put(0x0806, "rsa_pss_rsae_sha512");
        temp.put(0x0807, "ed25519");
        temp.put(0x0808, "ed448");
        temp.put(0x0809, "rsa_pss_pss_sha256");
        temp.put(0x080a, "rsa_pss_pss_sha384");
        temp.put(0x080b, "rsa_pss_pss_sha512");
        temp.put(0x0101, "rsa_md5");
        temp.put(0x0201, "rsa_pkcs1_sha1");
        temp.put(0x0202, "dsa_sha1");
        temp.put(0x0203, "ecdsa_sha1");
        temp.put(0x0301, "rsa_sha224");
        temp.put(0x0302, "dsa_sha224");
        temp.put(0x0303, "ecdsa_sha224");
        temp.put(0x0402, "rsa_pkcs1_sha256");
        sigSchemeMap = Collections.unmodifiableMap(temp);
    }
